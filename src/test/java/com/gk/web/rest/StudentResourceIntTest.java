...
import com.gk.service.mapper.StudentMapper;
...
public class StudentResourceIntTest extends AbstractCassandraTest {
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getRoll()).isEqualTo(DEFAULT_ROLL);
    }
    ...
    @Test
    public void checkRollIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students"))
            ...
            .andExpect(jsonPath("$.[*].roll").value(hasItem(DEFAULT_ROLL.toString())));
    }
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.roll").value(DEFAULT_ROLL.toString()));
    }
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getRoll()).isEqualTo(UPDATED_ROLL);
    }
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        studentDTO1.setId(UUID.randomUUID());
